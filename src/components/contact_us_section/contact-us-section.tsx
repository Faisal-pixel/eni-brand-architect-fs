...
import {
  EmailContactUsIcon,
  MarkerPinContactUsIcon,
  MessageChatCircleContactUsIcon,
  PhoneContactUsIcon,
} from "@/assets/icons";
...
const ContactSection = () => {
  ...
  const handleSubmit = async () => {
    ...
    const organizedData = {
      ...
      metadata: {
        submissionId: `contact_${Date.now()}_${Math.random()
          .toString(36)
          .substr(2, 9)}`,
        formVersion: "1.0",
  ...
  return (
    <div className="bg-white" ref={sectionRef}>
      <div className="max-w-full mx-auto">
        ...
        >
          <div className="text-[rgba(1,117,68,1)] text-sm leading-6 font-semibold mb-3">
            Contact us
          </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label
                      htmlFor="firstName"
                      className="block text-sm leading-5 font-medium text-gray-700 mb-1.5"
                    >
                      First name{" "}
                      <span className="text-[rgba(127,86,217,1)]">*</span>
                    </label>
                    <input
                      type="text"
                      id="firstName"
                ...
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("agreedToPolicy", e.target.checked)
                    }
                  ...
                  <label htmlFor="privacy" className="text-sm text-gray-600">
                    ...
                    <a
                      href="#"
                      className="text-gray-900 underline hover:text-green-600 transition-colors"
                    >
                      privacy policy
                    </a>
                    .
