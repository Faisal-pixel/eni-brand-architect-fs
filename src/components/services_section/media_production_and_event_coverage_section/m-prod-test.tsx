              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <video
                    ...
                    src="https://res.cloudinary.com/daya1fdka/video/upload/f_auto,q_auto/v1752459204/8371d80f-d358-433c-ad14-c47d78a063be_art5zr.mp4"
                    muted
                    ...
                    <div className="relative">
                      ...
                      {showSpeedMenu && (
                        <div className="absolute bottom-full right-0 mb-2 bg-black/90 rounded-lg p-2 min-w-[80px]">
                          <div className="text-white text-xs font-medium mb-2 px-2">Speed</div>
                            ...
                            {speedOptions.map((speed) => (
                              <button
                                ...
                                className={`block w-full text-left px-2 py-1 text-sm rounded hover:bg-white/20 transition-colors ${
                                  playbackSpeed === speed ? 'bg-white/20 text-white' : 'text-white/80'
                                }`}
                              >
                                {speed}×
                              </button>
